...
const Card = ({ projectGif, projectTitle, projectStack, projectDesc }) => {
    return (
        <div className="card w-[300px] h-[169px] md:w-[500px] md:h-[281px] ">
            <div className="content">
                <div className="back">
                    <div className="back-content">
                        ...
                        >
                            <g style={{ strokeWidth: "0" }} id="SVGRepo_bgCarrier"></g>
                            <g style={{ strokeLinejoin: "round", strokeLinecap: "round" }} id="SVGRepo_tracerCarrier"></g>
